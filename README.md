...
### Synthetic data augmentation — trained on 1M synthetic rows, tested on 214 real tracks

> Generated by the [Synthetic Radar Generator](synthetic_radar_generator/) — bootstrap + 5% noise from real distributions.

| Model | File | Acc | F1-macro | F1-small | F1-med | F1-large |
|---|---|---|---|---|---|---|
| **EDA-QJL k=512** ★ | `vessel_size_clf/edaqjl_synthetic1M.pkl` | **91.6%** | **0.892** | 0.863 | 0.870 | 0.943 |
| XGB Full-24 | `vessel_size_clf/xgb_full24_synthetic1M.pkl` | 89.7% | 0.872 | 0.831 | 0.840 | 0.944 |
